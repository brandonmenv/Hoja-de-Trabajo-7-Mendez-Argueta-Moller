...
public class BinarySearchTree<E extends Comparable<E>>
{
    ...
    {
        if (root.isEmpty()) throw new Error("No predecessor to middle value.");
        else 
           if(root.left().isEmpty()) throw new Error( "Root has left child.");
           else 
       {
    ...
    protected BinaryTree<E> successor(BinaryTree<E> root)
    {
        if (root.isEmpty()) throw new Error("No predecessor to middle value.");
           ...
           if(root.right().isEmpty()) throw new Error( "Root has left child.");
           else
        {
